    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="w-full max-w-md p-6 ">
                ...
                <div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg px-10 py-6 text-center">
                ...
                <div className=" text-center mt-2">
                    <a href="#" className="text-sm text-blue-500 hover:underline block text-start">Download a sample .xls template</a>
                    <a href="#" className="text-sm text-blue-500 hover:underline block text-start">Download a sample .csv template</a>
                </div>
